...
public class VehicleRentalApp {
    public static void main(String[] args) {
        ...
        // Uses the Singleton instance of RentalSystem instead of creating a new object
            ...
            switch (choice) {
                case 1:
                    ...
                    if (vehicle != null) {
                        ...
                        // Checks the boolean result so duplicate license plates are rejected
                ...
                case 2:
                    ...
                    // Checks the boolean result so duplicate customer IDs are rejected
